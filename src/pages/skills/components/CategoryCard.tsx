      ...
      >
        ...
        >
          ...
          <CardContent className="space-y-4 pt-0 px-4 pb-4 relative z-10 flex flex-col h-full">
            ...
            {/* Status Pills and Update Button at Bottom */}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="text-sm px-3 py-1 rounded-full bg-muted text-foreground hover:bg-muted/80 transition-colors cursor-pointer"
                    type="button"
                  >
                  ...
                  {pendingCount > 0 && (
                    <button
                      ...
                      className="text-sm px-3 py-1 rounded-full bg-muted/40 text-muted-foreground hover:bg-muted/60 transition-colors cursor-pointer"
                      type="button"
                    >
                ...
                <Button
                  ...
                  className="text-sm relative z-30 shrink-0"
                  type="button"
                >
