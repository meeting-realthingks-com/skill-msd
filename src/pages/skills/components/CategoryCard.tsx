          ...
          <CardContent className="space-y-4 pt-0 px-4 pb-4 relative z-10 flex flex-col h-full">
            ...
            <div className="flex justify-center items-center gap-8 py-4">
              <button
                ...
                className="flex flex-col items-center gap-2 hover:scale-110 transition-transform cursor-pointer relative z-20"
                type="button"
              >
            ...
            {/* Bottom Section - Status Pills and Update Button */}
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="text-sm px-3 py-1 bg-background border border-border rounded-full hover:bg-muted transition-colors cursor-pointer"
                    type="button"
                  >
                ...
                <Button
                  ...
                  className="text-sm px-4 py-1 relative z-30 shrink-0"
                  type="button"
                >
